        ...
        public void CrudTest()
        {
            using (var db = CreateAccessDB())
            {
                try
                {
                    ...
                    Product p1 = db.Query<Product>().FromView("V_Product").Graph()
                    ...
                    p1 = db.Query<Product>().FromView("V_Product").Graph()
                        .Where(p => p.Name == "P1").FirstOrDefault();
                    ...
                    var updatedP1 = db.Query<Product>().FromView("V_Product").Graph()
                        .Where(p => p.Name == "P1").FirstOrDefault();
                    ...
                    var deletedP1 = db.Query<Product>().FromView("V_Product").Graph()
                        .Where(p => p.Name == "P1").FirstOrDefault();
